...
export class TreePageComponent {
  ...
  protected readonly explorerCode = [
    ...
    '  <p>Selected: <code>{{ selected()[0] }}</code></p>',
    '} @else {',
    '  <p>Nothing selected</p>',
    '}',
  ].join('\n');
  protected readonly explorerTs = [
    "import { Component, signal } from '@angular/core';",
    "import { DmTreeComponent, DmTreeNode } from '@dmaster/ui';",
    '',
    '@Component({',
    "  selector: 'app-file-explorer',",
    '  imports: [DmTreeComponent],',
    "  templateUrl: './file-explorer.component.html',",
    '})',
    'export class FileExplorerComponent {',
    '  protected readonly files: DmTreeNode[] = [',
    "    { id: 'src', label: 'src', children: [",
    "      { id: 'src/app', label: 'app', children: [",
    "        { id: 'src/app/pages', label: 'pages', children: [",
    "          { id: 'src/app/pages/home.ts', label: 'home.ts' },",
    '        ] },',
    '      ] },',
    "      { id: 'src/main.ts', label: 'main.ts' },",
    ...
    '  ];',
    '',
    '  // The tree derives the visible rows from expandedIds.',
  ...
  protected readonly multipleTs = [
    ...
    '',
    '@Component({',
    "  selector: 'app-multi-tree',",
    '  imports: [DmTreeComponent],',
    "  templateUrl: './multi-tree.component.html',",
    '})',
    'export class MultiTreeComponent {',
    '  protected readonly files: DmTreeNode[] = [ /* … */ ];',
    '',
    '  // Clicking toggles each node in/out of selectedIds; aria-multiselectable is set.',
    "  protected readonly selected = signal<string[]>(['src/main.ts', 'public/favicon.svg']);",
    "  protected readonly expanded = signal<string[]>(['src', 'public']);",
    '',
    '  // Resolve the selected IDs to their labels, in tree order.',
  ...
  protected readonly controlledTs = [
    ...
    "import { DmButtonComponent, DmTreeComponent, DmTreeNode } from '@dmaster/ui';",
    '',
    '@Component({',
    "  selector: 'app-controlled-tree',",
    '  imports: [DmTreeComponent, DmButtonComponent],',
    "  templateUrl: './controlled-tree.component.html',",
    '})',
    'export class ControlledTreeComponent {',
    '  protected readonly files: DmTreeNode[] = [ /* … */ ];',
    '',
  ...
  protected readonly guidesCode = [
    ...
    '  showGuides',
    '  [(expandedIds)]="expanded"',
    '  ariaLabel="With guides" />',
  ].join('\n');
  protected readonly guidesTs = [
    "import { Component, signal } from '@angular/core';",
    "import { DmTreeComponent, DmTreeNode } from '@dmaster/ui';",
    '',
    '@Component({',
    "  selector: 'app-tree-guides',",
    '  imports: [DmTreeComponent],',
    "  templateUrl: './tree-guides.component.html',",
    '})',
    'export class TreeGuidesComponent {',
    '  protected readonly files: DmTreeNode[] = [ /* … */ ];',
    '',
    "  protected readonly expanded = signal<string[]>(['src', 'src/app', 'src/app/pages']);",
    '',
    '  // Or turn guides on app-wide: provideTreeDefaults({ showGuides: true })',
    '}',
  ].join('\n');
  ...
  protected readonly disabledTs = [
    ...
    '  protected readonly settings: DmTreeNode[] = [',
    ...
    '  ];',
    '',
    "  protected readonly selected = signal<string[]>(['general/profile']);",
    "  protected readonly expanded = signal<string[]>(['general', 'workspace']);",
    '}',
  ].join('\n');
  ...
  protected readonly keyboardTs = [
    ...
    '',
    '@Component({',
    "  selector: 'app-tree-keyboard',",
    '  imports: [DmTreeComponent],',
    "  templateUrl: './tree-keyboard.component.html',",
    '})',
    'export class TreeKeyboardComponent {',
    '  protected readonly files: DmTreeNode[] = [ /* … */ ];',
    '',
    '  protected readonly selected = signal<string[]>([]);',
    "  protected readonly expanded = signal<string[]>(['src']);",
    '',
    '  // The tree owns the full WAI-ARIA keyboard model — nothing to wire:',
