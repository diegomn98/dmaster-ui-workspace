...
describe('color-utils', () => {
  ...
  describe('hsvaToRgba', () => {
    const cases: [HSVA, { r: number; g: number; b: number }][] = [
      [{ h: 0, s: 1, v: 1, a: 1 }, { r: 255, g: 0, b: 0 }],
      [{ h: 120, s: 1, v: 1, a: 1 }, { r: 0, g: 255, b: 0 }],
      [{ h: 240, s: 1, v: 1, a: 1 }, { r: 0, g: 0, b: 255 }],
      [{ h: 0, s: 0, v: 1, a: 1 }, { r: 255, g: 255, b: 255 }],
      [{ h: 0, s: 0, v: 0, a: 1 }, { r: 0, g: 0, b: 0 }],
      [{ h: 60, s: 1, v: 1, a: 1 }, { r: 255, g: 255, b: 0 }],
    ];
